...
## Exercise 1
We load the data from the data source.z
```{r}
...
Comparing the first and second plot, we see that when the population of the samples are bigger, the power obtained for the test are more precise. For example in the first plot for *nu*=178 we get a power of `r p=get_p_values(30,30,180,178,5); p(mean<0.05);` while in the second plot we get a power of `r p=get_p_values(100,100,180,178,5); p(mean<0.05);`for the same value of *nu*.
